export default function ClassMeetingSection({ onPhotoClick }) {
  const photos = [
    {
      ...
      caption: "Tarik tambang epik vs IX-A",
      title: "Insiden Tambang Putus",
      story: "Lomba tarik tambang paling epik. Tambangnya nyaris putus dan kita semua jatuh ke lumpur. Semuanya kotor tapi ketawanya paling kenceng!"
    },
    {
      ...
      caption: "Juara 1 Futsal!",
      title: "Sang Juara Bertahan",
      story: "Gol menit terakhir dari Bima bikin satu lapangan teriak. Habis menang langsung ditraktir seblak sama wali kelas!"
    }
  ];
    ...
    <section className="mb-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div 
          ...
          className="bg-surface-container-lowest p-2 pb-8 shadow-[6px_6px_0px_0px_rgba(29,53,87,1)] relative -rotate-2 hover:rotate-0 hover:-translate-y-2 transition-all duration-300 cursor-pointer"
        >
          ...
          <p className="font-subheading-quote text-subheading-quote text-center text-primary-container px-2">{photos[0].caption}</p>
        </div>
        
        {/* Polaroid 2 */}
        <div 
          onClick={() => onPhotoClick && onPhotoClick(photos[1])}
          className="bg-surface-container-lowest p-2 pb-8 shadow-[6px_6px_0px_0px_rgba(29,53,87,1)] relative rotate-1 hover:rotate-0 hover:-translate-y-2 transition-all duration-300 lg:translate-y-4 cursor-pointer"
        >
          ...
          <p className="font-subheading-quote text-subheading-quote text-center text-primary-container px-2">{photos[1].caption}</p>
        </div>
