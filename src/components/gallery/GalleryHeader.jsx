  ...
  return (
    <section className="mb-xl relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant">Kumpulan memori acak, tawa di kantin, keringat saat class meeting, hingga tangis bangga saat kelulusan. Ini adalah kepingan cerita Kelas IX-B yang terekam selamanya.</p>
      </div>
      {/* Post-it Note */}
